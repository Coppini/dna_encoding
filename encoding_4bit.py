...
class EncodedQuality(NamedTuple):
    ...
    def decode(self) -> str:
        return Encoded4bitSequence.decode_quality(encoded_quality=self)

    def decode_into_scores(self) -> str:
        return list(Encoded4bitSequence.decode_quality_into_scores(encoded_quality=self))


@dataclass
class Encoded4bitSequence:
    """
    ...
    def from_sequence(
        ...
        """
        Create a Encoded4bitSequence instance from a DNA sequence, quality scores, and header information.
        ...
        Returns:
            Encoded4bitSequence: Instance of Encoded4bitSequence.
        """
        ...
        # Create and return the Encoded4bitSequence instance
        return cls(
    ...
    def encode_sequence(sequence: str) -> bytes:
        ...
        odd = len(sequence) % 2
        header = "0001" if odd else "00000000"
    ...
    def decode_sequence(encoded_bytes: bytes) -> str:
        ...
        is_odd = bits[:4] == "0001"
        bits_to_skip = (4 if is_odd else 8)
    ...
    def decode_quality(encoded_quality: EncodedQuality, ascii_base: int = 33) -> str:
        ...
        return "".join(
            ...
            for quality_score in Encoded4bitSequence.decode_quality_into_scores(encoded_quality)
        )
    ...
    def __str__(self) -> str:
        """
        Get a string representation of the Encoded4bitSequence.

        Returns:
            str: String representation of the Encoded4bitSequence.
        """
