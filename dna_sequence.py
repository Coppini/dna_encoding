...
class DNASequence:
    ...
    def from_sequence(
        ...
        """
        Create a DNASequence instance from a DNA sequence, quality scores, and header information.
        ...
        Returns:
            DNASequence: Instance of DNASequence.
        """
        ...
        # Create and return the DNASequence instance
        return cls(
    ...
    def decode_quality(encoded_quality: EncodedQuality, ascii_base: int = 33) -> str:
        ...
        return "".join(
            ...
            for quality_score in DNASequence.decode_quality_into_scores(encoded_quality)
        )
    ...
    def __str__(self) -> str:
        """
        Get a string representation of the DNASequence.

        Returns:
            str: String representation of the DNASequence.
        """
